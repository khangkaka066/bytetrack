...
def main(exp, args, num_gpu):
    ...
    # start evaluate
    if args.lstm_ckpt:
        *_, summary = evaluator.evaluate_lstm(
            model, is_distributed, args.fp16, trt_file, decoder, exp.test_size, results_folder, video_folder
        )
    elif args.xlstm_ckpt:
        *_, summary = evaluator.evaluate_xlstm(
            model, is_distributed, args.fp16, trt_file, decoder, exp.test_size, results_folder, video_folder
        )
    else:
